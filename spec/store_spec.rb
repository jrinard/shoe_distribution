...
describe Store do
  ...
  it "will show the rating exists and grab a specific store rating" do
    new_store = Store.create({:name => 'Foot Locker', :address => '1 Infinite Loop', :ratings => 4.1})
    new_store2 = Store.create({:name => 'Shoe Emporium', :address => '1 Infinite Loop', :ratings => 8.3})
    new_store3 = Store.create({:name => 'Famous Footwear', :address => '1 Infinite Loop', :ratings => 9.9})
    new_store4 = Store.create({:name => 'Payless', :address => '1 Infinite Loop', :ratings => 1.5})
  ...
  it("converts the Store name to Capitalized") do
    store = Store.new({:name => 'foot locker', :address => '1 Infinite Loop', :ratings => 4.1})
    store.save()
